...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("RazHubSettings.json") then
			writefile("RazHubSettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("RazHubSettings.json"))
	...
	options = self:set_defaults({
		...
		Link = "https://discord.gg/XEhCKFnhhA"
	}, options)
	...
	local homeButtonIcon = homeButton:object("ImageLabel", {
		...
		Image = "http://www.roblox.com/asset/?id=10163984598",
		Theme = {ImageColor3 = "StrongText"}
	})
	...
	creditsTab:credit{Name = "DummberClasses", Description = "Script Developer", Discord = "DummberClasses#9494"}
	...
	if setclipboard then
		...
		if options.V3rmillion then
			...
			local v3rmillion = v3rmillionContainer:object("ImageLabel", {
				Image = "http://www.roblox.com/asset/?id=782540407",
